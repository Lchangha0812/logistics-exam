...
import io.lchangha.logisticsexam.id.InboundOrderItemId;
...
public class InboundOrderItem {
    ...
    private InboundOrderItem(
        ...
        this.quantity = DomainValidator.requireNonNull(quantity, () -> new InvalidInboundOrderException("수량은 필수입니다."));
        DomainValidator.isTrue(quantity > 0, () -> new InvalidInboundOrderException("수량은 0보다 커야 합니다."));
